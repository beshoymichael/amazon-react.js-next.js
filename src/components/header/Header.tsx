...
useEffect(() => {
  ...
  return (
    <div className='w-full h-20 bg-amazon_blue text-white text-lightText sticky top-0 z-50'>
     ...
     <Image className='w-28 object-cover mt-1' src={logo} alt='logoImge'/>
     </Link>
      {/* delivary */}
      <div className='px-2 border border-transparent hover:border-white cursor-pointer duration-300 items-center justify-center h-[70%] hidden xl:inline-flex gap-1'>
        ...
        <div className='text-xs'>
         ...
         {userInfo ? (
          ...
          {/* fovorite */}
          <div className=' text-xs flex flex-col justify-center px-2 border border-transparent hover:border-white cursor-pointer duration-300 h-[70%] gap-1 relative'>
            <p>marked</p>
          ...
          <Image className='w-auto object-cover h-8 ' src={cartIcon} alt='cartImge'/>
